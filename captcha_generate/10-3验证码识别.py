...
image_batch, label_batch0, label_batch1, label_batch2, label_batch3, label_batch4 = tf.train.shuffle_batch(
        [image, label0, label1, label2, label3, label4], batch_size = BATCH_SIZE,
...
with tf.Session() as sess:
    ...
    for i in range(6001):
        # 获取一个批次的数据和标签
        b_image, b_label0, b_label1 ,b_label2 ,b_label3, b_label4 = sess.run([image_batch, label_batch0, label_batch1, label_batch2, label_batch3, label_batch4])
        # 优化模型
        ...
        if i % 20 == 0:  
            ...
            acc0,acc1,acc2,acc3,acc4,loss_ = sess.run([accuracy0,accuracy1,accuracy2,accuracy3,accuracy4,total_loss],feed_dict={x: b_image,
                                                                                                                y0: b_label0,
                                                                                                                y1: b_label1,
                                                                                                                y2: b_label2,
                                                                                                                y3: b_label3,
            ...
            print ("Iter:%d  Loss:%.3f  Accuracy:%.2f,%.2f,%.2f,%.2f,%.2f  Learning_rate:%.4f" % (i,loss_,acc0,acc1,acc2,acc3,acc4,learning_rate))
