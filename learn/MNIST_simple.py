...
prediction = tf.matmul(L1_drop, w_l2) + b_l2 # 使用交叉熵代价函数时有softmax激活函数
...
# train_step = tf.train.GradientDescentOptimizer(0.2).minimize(loss)   # 使用SGD梯度下降法
