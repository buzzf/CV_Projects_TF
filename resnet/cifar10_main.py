...
def preprocess_image(image, is_training): 
  ...
  if is_training:
    ...
    # Randomly crop a [_HEIGHT, _WIDTH] section of the image.  裁剪，数据增强
    image = tf.random_crop(image, [_HEIGHT, _WIDTH, _DEPTH])

    # Randomly flip the image horizontally. 翻转，数据增强
    image = tf.image.random_flip_left_right(image)

  # Subtract off the mean and divide by the variance of the pixels. 标准化
